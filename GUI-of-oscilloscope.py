...
# root.state('zoomed')
# root.bind("<Escape>", no_zoom() )
#### Frame for displayroot.state('zoomed')




display = tk.Label(root, text="DISPLAY", font='Helvetica 18 bold') # creating a label
display.place(relx=0.2,rely=0, anchor="nw",relwidth=0.3,relheight=0.1)# placing the label

frame = tk.Frame(root, borderwidth=1,bg="#0DBDAB",relief=tk.SUNKEN,bd=10)#creating frame for DSO display
frame.place(relx=1.0/3,rely=0.5, anchor="center", relwidth=0.60,relheight=0.8)#placing the dso display
...
#### Buttons 5FA8A8
##-----------------------------------------------------
###All the buttons will be fixed in a grid 
### Configuring coulumns for the grid.
